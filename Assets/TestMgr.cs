...
public class TestMgr : MonoBehaviour
{
    ...
    public void ResetEntities()
    {
        ...
        {
            Entity ent = EntityMgr.inst.entities[i];
    ...
    public void Crossing90()
    {
        ...
        Entity ent0 = EntityMgr.inst.CreateEntity(EntityType.DDG51, new Vector3(4500, 0, 1200), Vector3.zero);
        ent0.desiredHeading = 270f;
        ent0.heading = 270f;

        Entity ent1 = EntityMgr.inst.CreateEntity(EntityType.DDG51, new Vector3(2500, 0, 3200), Vector3.zero);
    ...
    {
        List<Entity> ent0List = new List<Entity>();
        ent0List.Add(EntityMgr.inst.entities[0]);
        AIMgr.inst.HandleMove(ent0List, new Vector3(500, 0, 1200));
        EntityMgr.inst.entities[0].GetComponent<UnitAI>().moves[0].movePosition = new Vector3(500, 0, 1200);
        added = true;

        List<Entity> ent1List = new List<Entity>();
        ent1List.Add(EntityMgr.inst.entities[1]);
        AIMgr.inst.HandleMove(ent1List, new Vector3(2500, 0, 200));
        EntityMgr.inst.entities[1].GetComponent<UnitAI>().moves[0].movePosition = new Vector3(2500, 0, 200);
        added = true;
    }
    ...
    public void Overtaking()
    {
        ...
        Entity ent1 = EntityMgr.inst.CreateEntity(EntityType.DDG51, new Vector3(3500, 0, 1200), Vector3.zero);
    ...
    public void OvertakingWaypoints()
    {
        ...
        EntityMgr.inst.entities[0].GetComponent<UnitAI>().moves[0].movePosition = new Vector3(-1500, 0, 1200);
        added = true;

        List<Entity> ent1List = new List<Entity>();
        ent1List.Add(EntityMgr.inst.entities[1]);
        AIMgr.inst.HandleMove(ent1List, new Vector3(-1500, 0, 1200));
        EntityMgr.inst.entities[1].GetComponent<UnitAI>().moves[0].movePosition = new Vector3(-1500, 0, 1200);
        added = true;
    }
    ...
    public void HeadOnWaypoints()
    {
        ...
        EntityMgr.inst.entities[1].GetComponent<UnitAI>().moves[0].movePosition = new Vector3(6500, 0, 1200);
        added = true;
    }
}